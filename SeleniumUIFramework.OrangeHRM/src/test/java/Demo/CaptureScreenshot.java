...
import com.orangehtm.seleniumuiframework.genericutility.ScreenShotUtility;
import com.orangehtm.seleniumuiframework.genericutility.WebDriverUtility;
...
public class CaptureScreenshot {
	...
	//	String timestamp = new SimpleDateFormat("yyyy-mm-dd[hh-mm-ss]").format(new Date());
		...
		su.captureScreenshot(driver,"test1");
		su.captureScreenshot(dsp.getRecuitment(),"Recuritment");
//		
